...
public class FoodDetailFragment extends Fragment implements TextWatcher {
    ...
    void onAddonClick()
    {
        ...
        {
            displayAddonList(); // Shows all add on options
    ...
    private void showDialogRating() {
        ...
        builder.setPositiveButton("OK", (dialogInterface, i) -> {
            ...
            serverTimeStamp.put("timeStamp", ServerValue.TIMESTAMP); //6:40 9th
    ...
    private void addRatingToFood(float ratingValue) {
        ...
        .child(Common.selectedFood.getKey()) //food item is array list so key is index of array
        .addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists())
                    {
                        ...
                        double result= sumRating/ratingCount;  //double sumRating = (foodModel.getRatingValue() * foodModel.getRatingCount())+ratingValue;

                        Map<String,Object> updateData = new HashMap<>();
                        updateData.put("ratingValue",result);
                        updateData.put("ratingCount", ratingCount);

                        // updates data in variable
